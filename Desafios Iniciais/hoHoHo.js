...
// a função gets é implementada dentro do sistema para ler as entradas(inputs) 
//dos dados e a função print para imprimir a saída (output) de dados e já pula uma linha ("\n")
